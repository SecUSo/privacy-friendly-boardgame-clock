            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    for (int i = 0; i < game_timers.getChildCount(); i++)
                        if (game_timers.getChildAt(i) instanceof org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) {
                            game_timers.getChildAt(i).setEnabled(false);
                            for (int j = 0; j < ((org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) game_timers.getChildAt(i)).getChildCount(); j++)
                                if (((org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) game_timers.getChildAt(i)).getChildAt(j) instanceof EditText)
                                    ((EditText) ((org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) game_timers.getChildAt(i)).getChildAt(j)).setTextColor(Color.LTGRAY);
                    ...
                    for (int i = 0; i < game_timers.getChildCount(); i++)
                        if (game_timers.getChildAt(i) instanceof org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) {
                            ...
                            for (int j = 0; j < ((org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) game_timers.getChildAt(i)).getChildCount(); j++)
                                if (((org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) game_timers.getChildAt(i)).getChildAt(j) instanceof EditText)
                                    ((EditText) ((org.secuso.privacyfriendlyboardgameclock.view.NumberPicker) game_timers.getChildAt(i)).getChildAt(j)).setTextColor(Color.BLACK);
                        } else if (game_timers.getChildAt(i) instanceof TextView)
