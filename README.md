...
[![Translation status](https://hosted.weblate.org/widget/pfa/boardgame-clock/boardgame-clock-android-app/svg-badge.svg)](https://hosted.weblate.org/engage/pfa/)

[PFA]: https://secuso.org/pfa
[Mastodon]: https://xn--baw-joa.social/@SECUSO_Research
[Bluesky]: https://bsky.app/profile/secusoresearch.bsky.social
<img src="https://github.com/SecUSo/privacy-friendly-boardgame-clock/raw/master/fastlane/metadata/android/en-US/images/icon.png"
...
The Privacy Friendly Boardgame Clock belongs to the group of Privacy Friendly Apps.
The app assists its users to play round-based board games using a clock like chess.
Players can be created and reused in-between games and a history of games.

This app is optimized regarding the user's privacy. It does not need any permissions.

## Motivation

Privacy Friendly Boardgame Clock belongs to the group of Privacy Friendly Apps and has been developed to provide a privacy friendly timer for round based boardgames like chess. More information can be found on https://secuso.org/pfa
...
If you want to help translate this app, you can use [Weblate](https://hosted.weblate.org/projects/pfa/boardgame-clock/boardgame-clock-android-app/).

<a href="https://hosted.weblate.org/engage/pfa/">
<img src="https://hosted.weblate.org/widget/pfa/boardgame-clock/boardgame-clock-android-app/multi-auto.svg" alt="Translation status" />
</a>
...
<a href="https://github.com/SecUSo/privacy-friendly-boardgame-clock/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=SecUSo/privacy-friendly-boardgame-clock&max=100&columns=20" />
</a>
